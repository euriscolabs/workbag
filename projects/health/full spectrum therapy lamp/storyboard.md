...
- Two reasons:
  1. **Warmth** — infrared radiation is genuinely relaxing (like lying in the sun).
  2. **Bright light entering the eyes** — this is the big one. It triggers:
...
1. **Light source** — The centrepiece of the lamp. I was looking at using something like an LED strip, but with full-spectrum light.
2. **Electronics** — Our light will need a power source, a switch, and a dial to adjust the brightness.
3. **Housing** — A lighting cover, rods, and a stand.
4. **Mechanical parts** — A desk clamp, hinges for the light rods, and the stand.
