...
The spool holder is the hardware foundation for the [Auto-Tuner](../auto-tuner/index.md) project. Its sensors serve double duty:
...
This project is **Phase 1** of the shared roadmap with the [Auto-Tuner](../auto-tuner/index.md). It delivers standalone value and provides the sensor foundation for all subsequent phases.
...
Add the roller encoder and cutter mechanism. Prove jam detection works reliably and the cutter responds correctly. Test with intentional jams. The roller encoder also provides E-step calibration, live slip detection, flow monitoring, and max volumetric flow measurement — feeding directly into the [Auto-Tuner](../auto-tuner/index.md) Phase 2.

### Later Phases
Phases 2–5 (auto-tuner software, thermal camera, productization, kit sales) are tracked in the [Auto-Tuner](../auto-tuner/index.md) roadmap.
