...
- [3D Printer Auto-Tuner](./projects/auto%20tuner/index.md) — Automatic calibration system using sensors, CV, and G-code automation
- [Filament Spool Holder](./projects/filament%20spool%20holder/index.md) — All-in-one drybox, inline cleaner, and jam-safety cutter
- [Filament Recycler](./projects/filament%20recycler/index.md) — Recycle failed prints into usable filament with closed-loop quality control
