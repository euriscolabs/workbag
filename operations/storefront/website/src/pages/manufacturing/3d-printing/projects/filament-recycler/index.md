...
Turn failed prints, support material, purge waste, and old prototypes back into usable filament. Shred, melt, extrude, and spool — with quality control provided by the [Filament Spool Holder](../filament-spool-holder/index.md) acting as a quality gate for the output.
...
The [Filament Spool Holder](../filament-spool-holder/index.md) provides closed-loop quality control for recycled filament:
