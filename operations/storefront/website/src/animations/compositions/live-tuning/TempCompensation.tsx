  ...
  return (
    <svg width="700" height="580" viewBox="0 0 700 580">
      ...
      <g>
        ...
        {/* Target line */}
        <line x1={graphX} y1={graphY + graphHeight / 2} x2={graphX + graphWidth} y2={graphY + graphHeight / 2} stroke={calibration.correct + "44"} strokeWidth="1.5" strokeDasharray="6,4" />
        <text x={graphX + graphWidth + 5} y={graphY + graphHeight / 2 + 4} fill={calibration.correct} fontSize="12" fontFamily="Space Grotesk">
          {targetTemp}°C
        </text>

        {/* Tolerance band */}
        <rect x={graphX} y={graphY + graphHeight / 2 - 8} width={graphWidth} height="16" fill={calibration.correct + "0a"} />
        ...
        {Array.from({ length: 9 }, (_, i) => (
          <g key={i}>
            <line x1={graphX + (i / 8) * graphWidth} y1={graphY + graphHeight} x2={graphX + (i / 8) * graphWidth} y2={graphY + graphHeight + 5} stroke={colors.skyBlue + "44"} strokeWidth="1" />
            <text x={graphX + (i / 8) * graphWidth} y={graphY + graphHeight + 18} textAnchor="middle" fill={colors.skyBlue + "66"} fontSize="10" fontFamily="Space Grotesk">
              {i}h
            </text>
          </g>
        ))}
      ...
      <g transform="translate(60, 280)">
        ...
        <g transform="translate(0, 20)">
          <rect x="0" y="0" width="260" height="70" rx="6" fill={colors.deepBlue} stroke={colors.skyBlue + "33"} strokeWidth="1" />
          <text x="130" y="22" textAnchor="middle" fill={colors.skyBlue} fontSize="14" fontWeight="600" fontFamily="Space Grotesk">
            Ambient Temperature
          </text>
          <text x="130" y="42" textAnchor="middle" fill={colors.skyBlue} fontSize="12" fontFamily="Space Grotesk">
            Room warms during day, cools at night
          </text>
          <text x="130" y="58" textAnchor="middle" fill={colors.skyBlue} fontSize="11" fontFamily="Space Grotesk">
        ...
        <g transform="translate(280, 20)">
          <rect x="0" y="0" width="260" height="70" rx="6" fill={colors.deepBlue} stroke={colors.skyBlue + "33"} strokeWidth="1" />
          <text x="130" y="22" textAnchor="middle" fill={calibration.tooHigh + "cc"} fontSize="14" fontWeight="600" fontFamily="Space Grotesk">
            Heat Creep
          </text>
          <text x="130" y="42" textAnchor="middle" fill={colors.skyBlue} fontSize="12" fontFamily="Space Grotesk">
      ...
      <g transform="translate(60, 410)">
        ...
        {/* Hour 1 (always fine) */}
        <g transform="translate(0, 20)">
          <text x="130" y="12" textAnchor="middle" fill={colors.skyBlue} fontSize="12" fontFamily="Space Grotesk">Hour 1</text>
          <rect x="30" y="20" width="200" height="12" rx="6" fill={calibration.correct + "44"} stroke={calibration.correct} strokeWidth="1.5" />
        </g>

        {/* Hour 7 (depends on compensation) */}
        <g transform="translate(280, 20)">
          <text x="130" y="12" textAnchor="middle" fill={colors.skyBlue} fontSize="12" fontFamily="Space Grotesk">Hour 7</text>
          {(() => {
            if (value < 0.3) {
              ...
              return (
                <>
                  {Array.from({ length: 10 }, (_, i) => (
                    <rect key={i} x={30 + i * 20} y="20" width={14 + Math.sin(i) * 4} height={12 + Math.sin(i * 2) * 4} rx="3" fill={calibration.tooLow + "44"} stroke={calibration.tooLow} strokeWidth="1" />
                  ))}
                  <text x="130" y="50" textAnchor="middle" fill={calibration.tooLow} fontSize="11" fontFamily="Space Grotesk">
              ...
              return (
                <>
                  <polyline points={pts.join(" ")} fill="none" stroke={calibration.tooHigh} strokeWidth="3" />
                  <text x="130" y="50" textAnchor="middle" fill={calibration.tooHigh} fontSize="11" fontFamily="Space Grotesk">
              ...
              return (
                <>
                  <rect x="30" y="20" width="200" height="12" rx="6" fill={calibration.correct + "44"} stroke={calibration.correct} strokeWidth="1.5" />
                  <text x="130" y="50" textAnchor="middle" fill={calibration.correct} fontSize="11" fontFamily="Space Grotesk">
      ...
      <g transform="translate(60, 510)">
        <text x="280" y="0" textAnchor="middle" fill={colors.skyBlue} fontSize="12" fontFamily="Space Grotesk">
